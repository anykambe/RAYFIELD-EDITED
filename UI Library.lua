...
function RayfieldLibrary:CreateWindow(Settings)
	...
	function Window:CreateTab(Name,Image)
        ...
        function Tab:DeleteButton(ButtonName)
            -- Find the button by name in the TabPage
            local Button = TabPage:FindFirstChild(ButtonName)
            if Button then
                -- Tween out the button's visuals before removing it
